...
import AutomaticDatabaseBackupusingNode from '../Assets/Images/Projects/AutomaticDatabaseBackupusingNode.jpg';
...
const PROFILE = [
  {
    ...
    projects: [
      ...
      {
        name: 'Automatic Database Backup using Node.js',
        techStack: ['Node.js', 'Cron', 'JavaScript', 'SQL'],
        shortDescription: 'Automate SQL database backups with Node.js and cron jobs.',
        description: 'Simplify your database management with Automatic Database Backup. This Node.js application automates SQL database backups, offering flexibility in scheduling (daily, hourly, etc.). Easily set up databases, create backup folders, and customize backup schedules. Seamlessly integrate into your projects for hassle-free, automated SQL database backups.',
        projectImg: AutomaticDatabaseBackupusingNode,
      },
      {
        name: 'CliqRaiser.com',
        client: 'Cliq Raiser',
